...
class CohostVoucherTest extends TestCase
{
    ...
    public function test_a_voucher_waives_the_base_fee_and_settles_the_invoice(): void
    {
        ...
        // Bukan transaksi BorderPay Rp 0 — laporan keuangan harus bisa membedakannya.
    ...
    /** Slot yang add-on-nya sudah dibayar lewat BorderPay tidak boleh dilepas sembarangan. */

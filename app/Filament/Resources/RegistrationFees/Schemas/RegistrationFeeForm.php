                ...
                Section::make('Registration Fee')
                    ...
                    ->schema([
                        ...
                        Select::make('audience')
                            ...
                            ->options([
                                'presenter' => 'Presenter / Pemakalah',
                                'participant' => 'Seminar participant / Peserta',
                                // Bukan tarif pendaftaran: ini biaya kemitraan yang
                                // ditagihkan saat pengajuan co-host disetujui.
                                'cohost' => 'Co-host partnership / Kemitraan co-host',
                            ])
                            ->live()
                            ->required(),
                        Select::make('registrant_category')
                            ...
                            ->visible(fn ($get): bool => $get('audience') !== 'cohost'),

            ...
            <div class="space-y-4 text-slate-600">
                @if($s->contact_email)
                    <p class="flex items-center gap-3">
                        <span class="h-9 w-9 rounded-lg bg-[var(--brand)]/10 text-[var(--brand-ink)] flex items-center justify-center shrink-0">
                        ...
                        <a href="mailto:{{ $s->contact_email }}" class="hover:text-[var(--brand-ink)] font-medium">{{ $s->contact_email }}</a>
                    </p>
                @endif
                ...
                @if($s->contact_address)
                    <p class="flex items-start gap-3">
                        <span class="h-9 w-9 rounded-lg bg-[var(--brand)]/10 text-[var(--brand-ink)] flex items-center justify-center shrink-0 mt-0.5">

...
2. Pilih metode bayar:
   ...
   - **Gateway**: redirect ke halaman pembayaran BorderPay → setelah bayar, webhook memicu penyelarasan dan status `paid` ditetapkan dari jawaban `GET /payments/{reference}`, bukan dari isi webhook.
